...
class BotPermissions {
    ...
    getPermissions_role_channel(roleId, serverId, channelId) {
        ...
        if (channelId) {
            permissions.importCustomPermissions(
                this.memory.get(this.memory.createKey.strings.permissionsNamespace,
    ...
    getPermissions_global(userId) {
        ...
        permissions.importCustomPermissions(
            this.memory.get(this.memory.createKey.strings.permissionsNamespace, this.memory.createKey.user_global(userId))
        );
        return permissions;
    }
    ...
    getPermissions_channel(userId, serverId, channelId) {
        ...
        if (serverId) {
            permissions.importCustomPermissions(
                this.memory.get(this.memory.createKey.strings.permissionsNamespace, this.memory.createKey.user_server(serverId, userId))
            );
        }
    ...
    editPermissions_user_channel(userId, channelId, permissionName, value) {
        ...
        let customPerms = this.memory.get(this.memory.createKey.strings.permissionsNamespace,
            this.memory.createKey.user_channel(serverId, userId, channelId)
        );
        ...
        if (customPerms.length) {
            this.memory.write(this.memory.createKey.strings.permissionsNamespace,
