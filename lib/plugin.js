...
class BotPlugin {
    ...
    _registerCommand(name, func, options) {
        this.bot.commandManager.registerCommand(name, this._pluginName, func.bind(this), options);
    }
    ...
    _registerPrecommandHander(precommand, func) {
        this.bot.commandManager.registerPrecommand(precommand, func.bind(this));
    }
}
